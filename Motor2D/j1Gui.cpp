...
UiItem_HealthBar * j1Gui::AddHealthBar(iPoint position, const SDL_Rect* staticSection, const SDL_Rect* dynamicSection, UiItem*const parent) // , TypeBar type)
{
	UiItem* newUIItem = nullptr;

	newUIItem = new UiItem_HealthBar(position, staticSection, dynamicSection, parent);
