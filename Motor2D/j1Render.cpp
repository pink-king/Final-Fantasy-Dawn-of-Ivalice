...
// Blit to screen
bool j1Render::Blit(SDL_Texture* texture, int x, int y, const SDL_Rect* section, float speed, SDL_RendererFlip flip, uint scale, double angle, int pivot_x, int pivot_y) const
{
	bool ret = true;
	SDL_Rect rect;
