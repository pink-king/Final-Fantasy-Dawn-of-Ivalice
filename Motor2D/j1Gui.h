...
//	void HideInGameEnemyUI(bool); 
	...
	UiItem_HealthBar* AddExperienceBar(iPoint position, const SDL_Rect* dynamicSection, const SDL_Rect* divisionSection, const SDL_Rect* staticSection, type variant, bool experience, UiItem* const parent = nullptr);
