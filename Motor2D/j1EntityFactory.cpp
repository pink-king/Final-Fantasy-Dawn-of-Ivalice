...
j1Entity* j1EntityFactory::CreateAsset(EnvironmentAssetsTypes type, iPoint worldPos, SDL_Rect atlasSpriteRect, BreakableType breakableType, bool isBroken, ChestType chestType, bool containsLoot)
{
	...
	case EnvironmentAssetsTypes::BREAKABLE_ASSET:
		assetEntity = DBG_NEW BreakableAsset(worldPos, breakableType, isBroken, containsLoot);
		entities.push_back(assetEntity);
		break; 
	...
	case EQUIPABLE_TYPE::SWORD:
		...
		for (auto node : config.child("loot").child("equipable").child("sword").children("equipment"))
		{
			...
			if (id == 3)
			{
				...
				lootEntity->CreateBuff(BUFF_TYPE::ADDITIVE, lootEntity->character, "\0", lootEntity->elemetalType, ROL::ATTACK_ROL, GetRandomValue(10, 15) + lootEntity->level * 20, lootEntity);
				lootEntity->CreateBuff(BUFF_TYPE::ADDITIVE, lootEntity->character, "inteligence", lootEntity->elemetalType, ROL::DEFENCE_ROL, GetRandomValue(5, 15) + lootEntity->level * 10, lootEntity);
				lootEntity->CreateBuff(BUFF_TYPE::MULTIPLICATIVE, lootEntity->character, "inteligence", ELEMENTAL_TYPE::NO_ELEMENT, ROL::COOLDOWN, GetRandomValue(75, 100) * 0.01 - lootEntity->level * 0.04, lootEntity);
	...
	case EQUIPABLE_TYPE::BOW:
		...
		for (auto node : config.child("loot").child("equipable").child("bow").children("equipment"))
		{
			...
			if (id == 3)
			{
				lootEntity->lootname = node.attribute("name").as_string();
				lootEntity->name.assign(lootEntity->lootname.data());
				lootEntity->CreateBuff(BUFF_TYPE::ADDITIVE, lootEntity->character, "inteligence", lootEntity->elemetalType, ROL::ATTACK_ROL, GetRandomValue(10, 15) + lootEntity->level * 20, lootEntity);
				lootEntity->CreateBuff(BUFF_TYPE::MULTIPLICATIVE, lootEntity->character, "\0", ELEMENTAL_TYPE::NO_ELEMENT, ROL::COOLDOWN, GetRandomValue(75, 100) * 0.01 - lootEntity->level * 0.04, lootEntity);
	...
	case EQUIPABLE_TYPE::ROD:
		...
		for (auto node : config.child("loot").child("equipable").child("rod").children("equipment"))
		{
			...
			if (id == 3)
			{
				lootEntity->lootname = node.attribute("name").as_string();
				lootEntity->name.assign(lootEntity->lootname.data());
				lootEntity->CreateBuff(BUFF_TYPE::ADDITIVE, lootEntity->character, "inteligence", lootEntity->elemetalType, ROL::ATTACK_ROL, GetRandomValue(10, 20) + lootEntity->level * 30, lootEntity);
				lootEntity->CreateBuff(BUFF_TYPE::MULTIPLICATIVE, lootEntity->character, "inteligence", ELEMENTAL_TYPE::NO_ELEMENT, ROL::COOLDOWN, GetRandomValue(65, 85) * 0.01 + lootEntity->level * 0.04, lootEntity);
				lootEntity->CreateBuff(BUFF_TYPE::MULTIPLICATIVE, lootEntity->character, "inteligence", ELEMENTAL_TYPE::NO_ELEMENT, ROL::VELOCITY, GetRandomValue(75, 100) * 0.01 + lootEntity->level * 0.04, lootEntity);
	...
	case EQUIPABLE_TYPE::ARMOR:
		...
		for (auto node : config.child("loot").child("equipable").child("armor").children("equipment"))
		{
			...
			if (id == 3)
			{
				...
				lootEntity->CreateBuff(BUFF_TYPE::ADDITIVE, lootEntity->character, "inteligence", ELEMENTAL_TYPE::NO_ELEMENT, ROL::VELOCITY, GetRandomValue(1, 2) * 0.1 + lootEntity->level * 0.02, lootEntity);
				lootEntity->CreateBuff(BUFF_TYPE::ADDITIVE, lootEntity->character, "inteligence", ELEMENTAL_TYPE::NO_ELEMENT, ROL::HEALTH, GetRandomValue(10, 15) + lootEntity->level * 4, lootEntity);
	...
	case EQUIPABLE_TYPE::MANTLE:
		...
		for (auto node : config.child("loot").child("equipable").child("mantle").children("equipment"))
		{
			...
			if (id == 3)
			{
				lootEntity->lootname = node.attribute("name").as_string();
				lootEntity->name.assign(lootEntity->lootname.data());
				lootEntity->CreateBuff(BUFF_TYPE::ADDITIVE, lootEntity->character, "inteligence", lootEntity->elemetalType, ROL::DEFENCE_ROL, GetRandomValue(15, 20) + lootEntity->level * 20, lootEntity);
				lootEntity->CreateBuff(BUFF_TYPE::ADDITIVE, lootEntity->character, "inteligence", ELEMENTAL_TYPE::NO_ELEMENT, ROL::VELOCITY, GetRandomValue(1, 2) * 0.1 + lootEntity->level * 0.02, lootEntity);
				lootEntity->CreateBuff(BUFF_TYPE::ADDITIVE, lootEntity->character, "inteligence", ELEMENTAL_TYPE::NO_ELEMENT, ROL::HEALTH, GetRandomValue(10, 15) + lootEntity->level * 4, lootEntity);
		...
		case EQUIPABLE_TYPE::SWORD:
			...
			for (auto node : config.child("loot").child("equipable").child("sword").children("equipment"))
			{
				...
				if (id == randID)
				{
					...
					if (id == 1)
					{
						lootEntity->CreateBuff(BUFF_TYPE::ADDITIVE, lootEntity->character, "inteligence", lootEntity->elemetalType, ROL::ATTACK_ROL, GetRandomValue(5, 9) + lootEntity->level * 10, lootEntity);
		...
		case EQUIPABLE_TYPE::BOW:
			...
			for (auto node : config.child("loot").child("equipable").child("bow").children("equipment"))
			{
				...
				if (id == randID)
				{
					...
					if (id == 1)
					{
						lootEntity->CreateBuff(BUFF_TYPE::ADDITIVE, lootEntity->character, "inteligence", lootEntity->elemetalType, ROL::ATTACK_ROL, GetRandomValue(3, 7) + lootEntity->level * 7, lootEntity);
						lootEntity->CreateBuff(BUFF_TYPE::MULTIPLICATIVE, lootEntity->character, "inteligence", ELEMENTAL_TYPE::NO_ELEMENT, ROL::COOLDOWN, GetRandomValue(75, 100) * 0.01 - lootEntity->level * 0.02, lootEntity);
					}
					...
					else if (id == 2)
					{
						...
						lootEntity->CreateBuff(BUFF_TYPE::ADDITIVE, lootEntity->character, "inteligence", lootEntity->elemetalType, ROL::ATTACK_ROL, GetRandomValue(3, 9) + lootEntity->level * 7, lootEntity);
		...
		case EQUIPABLE_TYPE::ROD:
			...
			for (auto node : config.child("loot").child("equipable").child("rod").children("equipment"))
			{
				...
				if (id == randID)
				{
					...
					if (id == 1)
					{					
							lootEntity->CreateBuff(BUFF_TYPE::ADDITIVE, lootEntity->character, "inteligence", lootEntity->elemetalType, ROL::ATTACK_ROL, GetRandomValue(10, 13) + lootEntity->level * 7, lootEntity);
							lootEntity->CreateBuff(BUFF_TYPE::MULTIPLICATIVE, lootEntity->character, "inteligence", ELEMENTAL_TYPE::NO_ELEMENT, ROL::COOLDOWN, GetRandomValue(75, 100) * 0.01 - lootEntity->level * 0.02, lootEntity);
					}

					else if (id == 2)
					{
						lootEntity->CreateBuff(BUFF_TYPE::ADDITIVE, lootEntity->character, "inteligence", lootEntity->elemetalType, ROL::ATTACK_ROL, GetRandomValue(5, 10) + lootEntity->level * 7, lootEntity);
						lootEntity->CreateBuff(BUFF_TYPE::MULTIPLICATIVE, lootEntity->character, "inteligence", ELEMENTAL_TYPE::NO_ELEMENT, ROL::VELOCITY, GetRandomValue(75, 100) * 0.01 + lootEntity->level * 0.02, lootEntity);
					}
				}
			}
			break;
